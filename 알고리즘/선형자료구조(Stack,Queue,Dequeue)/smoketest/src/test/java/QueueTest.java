import org.example.queue.ListBasedQueue;
...
public class QueueTest {
    ...
    public void testRandomOperations() {
        ...
        ListBasedQueue<Integer> testQueue = new ListBasedQueue<>();
            ...
            try {
                switch (op) {
                    ...
                    case "empty" -> {
                        ...
                        boolean testVal = testQueue.empty();
                        assertEquals(refVal, testVal);
                    }
                    case "size" -> {
                        int refVal = referenceQueue.size();
                        int testVal = testQueue.size();
                        assertEquals(refVal, testVal);
                    }
                }
            } catch (Exception e) {
